...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SourceType.description'
        db.add_column(u'payment_sourcetype', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'SourceType.is_defered'
        db.add_column(u'payment_sourcetype', 'is_defered',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SourceType.description'
        db.delete_column(u'payment_sourcetype', 'description')

        # Deleting field 'SourceType.is_defered'
        db.delete_column(u'payment_sourcetype', 'is_defered')
