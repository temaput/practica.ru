...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'payment_sourcetype', (
        ...
        db.send_create_signal(u'payment', ['SourceType'])
        ...
        # Adding model 'Source'
        db.create_table(u'payment_source', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sources', to=orm['order.Order'])),
            ('source_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sources', to=orm['payment.SourceType'])),
            ('currency', self.gf('django.db.models.fields.CharField')(default=u'\u0440\u0443\u0431.', max_length=12)),
        ...
        db.send_create_signal(u'payment', ['Source'])

        # Adding model 'Bankcard'
        db.create_table(u'payment_bankcard', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('partner_reference', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'payment', ['Bankcard'])


    def backwards(self, orm):
        # Deleting model 'SourceType'
        db.delete_table(u'payment_sourcetype')

        # Deleting model 'Transaction'
        db.delete_table(u'payment_transaction')

        # Deleting model 'Source'
        db.delete_table(u'payment_source')

        # Deleting model 'Bankcard'
        db.delete_table(u'payment_bankcard')
    ...
    models = {
        ...
        u'order.order': {
            ...
            'currency': ('django.db.models.fields.CharField', [], {'default': "u'\\u0440\\u0443\\u0431.'", 'max_length': '12'}),
