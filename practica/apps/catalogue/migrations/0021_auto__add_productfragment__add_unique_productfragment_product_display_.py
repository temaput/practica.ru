...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'catalogue_productfragment', (
            ...
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'fragments', to=orm['catalogue.Product'])),
        ...
        # Adding field 'Product.contents'
        db.add_column(u'catalogue_product', 'contents',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Product.contents'
        db.delete_column(u'catalogue_product', 'contents')
    ...
    models = {
        ...
        u'catalogue.productfragment': {
            'Meta': {'ordering': "[u'display_order']", 'unique_together': "((u'product', u'display_order'),)", 'object_name': 'ProductFragment'},
            'caption': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'display_order': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'original': ('django.db.models.fields.files.FileField', [], {'max_length': '255'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'fragments'", 'to': u"orm['catalogue.Product']"})
        },
